...
Virt Network Device plugin is [Apache 2.0 licensed](LICENSE) and accepts contributions via GitHubpull requests. This document outlines some of the conventions on development workflow, commit message formatting, contact points and other resources to make it easier to get your contribution accepted.
...
* Make sure to create an [Issue](https://github.com/zshi-redhat/virt-network-device-plugin/issues) for bug fix or the feature request.
...
* **For feature requests**, For the feature requests, please follow the issue template format while creating a feature requests. We want to improve upon Virt Network device plugin incrementally which means small changes or features at a time.
...
> We encourage contributor to test Virt Network Device plugin with various virtual NICs to check the compatibility.
